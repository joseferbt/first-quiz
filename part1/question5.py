...
select animals.name, favorite_foods.name from animals , favorite_foods where 
favorite_food_id in (select food_id from favorite_foods where vegetarian = 1) and
favorite_food_id = food_id
